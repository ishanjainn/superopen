...
const (
	// SuperopenEnvironment is the deployment environment
	SuperopenEnvironment = "superopen.environment"
	// SuperopenApplicationName is the application name
	SuperopenApplicationName = "superopen.application.name"
	// SuperopenSDKVersion is the SDK version
	SuperopenSDKVersion = "superopen.sdk.version"
)
