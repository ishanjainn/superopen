// Package guards evaluates detection rules. Match conditions are CEL expressions
// over an endpoint event, with an embedded-fixture conformance harness.
package guards
...
// EventList returns the fixture's events as plain events for evaluation.
func (f Fixture) EventList() []Event {
...
// FixtureEvent wraps a Event so fixture YAML can use the event's JSON field names
