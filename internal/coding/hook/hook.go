...
import (
	...
	"github.com/ishanjainn/superopen/internal/coding/hook/cursor"
	"github.com/ishanjainn/superopen/internal/coding/hook/generic"
	"github.com/ishanjainn/superopen/internal/coding/hook/opencode"
	"github.com/ishanjainn/superopen/internal/coding/hook/pi"
...
func peekContext(payload []byte) peekedContext {
	...
	// sessionID (OpenCode) is distinct from sessionId — include both casings.
