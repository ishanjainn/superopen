...
// Two inputs:
//
//  1. API-key identity. If the API key sending this telemetry is on the
//     org's allowlist, the user is recognized as a work identity.
//
...
type Inputs struct {
	...
	// registered as a "work identity" for this deployment.
	...
	// RepoURL is the canonical remote URL collected by internal/agent/git.
