...
// SDK via sdk.Config.Sampler.
//
// Beta default (used when SUPEROPEN_CODING_SAMPLE_EVENTS is unset): keep
...
//
// Set SUPEROPEN_CODING_SAMPLE_EVENTS=drop_requested to enable the
...
func (s spanNameSampler) Description() string {
	return "superopen.coding_agent.span_name_sampler"
}
