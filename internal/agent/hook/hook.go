...
import (
	...
	"github.com/ishanjainn/superopen/internal/agent/hook/generic"
	"github.com/ishanjainn/superopen/internal/agent/hook/opencode"
	"github.com/ishanjainn/superopen/internal/agent/hook/pi"
...
func run(cmd *cobra.Command, vendor, event string) (rerr error) {
	...
	emit, err := export.NewEmitter(ctx, cfg, adapter.Vendor(), sessionAttrs)
	if err != nil {
